...
avis0 =avis
data11 = pd.read_csv(r"/mount/src/l-analyse-des-sentiments-dans-la-gestion-des-changements-en-entreprise-avec-les-llms/streamlit_App/Resultats/predictions_bart_large_mnli_1.csv")
